...
/**
 * The Class RoundedNetworkImageView.<br/>
 * <code>RoundedNetworkImageView extends NetworkImageView</code><br/> Is a Custom <code>ImageView</code> class.<br/>
...
public class RoundedNetworkImageView extends NetworkImageView{
     ...
     */
    public RoundedNetworkImageView(Context context, AttributeSet attribs) {
        super(context, attribs);
        TypedArray a=getContext().obtainStyledAttributes(
                attribs,
                R.styleable.RoundedNetworkImageView);
        mRadius = a.getInt(
                R.styleable.RoundedNetworkImageView_radius,4);
        mMargin = a.getInt(
                R.styleable.RoundedNetworkImageView_margin,0);
        isShadowed = a.getBoolean(
                R.styleable.RoundedNetworkImageView_isShadowPresent,false);

        isCircular = a.getBoolean(R.styleable.RoundedNetworkImageView_isCircular, false);

        drawCircle = a.getBoolean(R.styleable.RoundedNetworkImageView_drawCircle, false);

        mCircleColor = a.getColor(R.styleable.RoundedNetworkImageView_circleColor, Color.WHITE);
     ...
     */
    public RoundedNetworkImageView(Context context, AttributeSet attribs, int defStyle) {
        ...
        int src_resource = attribs.getAttributeResourceValue("http://schemas.android.com/apk/res/android", "src", R.drawable.rectangle);
        if(src_resource != 0)
            setImageResource(src_resource);
        a.recycle();
        setWillNotDraw(false);
